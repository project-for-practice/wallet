...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div
                class="relative w-full flex items-center justify-center bg-[#F5EFFF] py-3 px-6"
            >
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header
                        class="grid grid-cols-2 justify-between items-center gap-2"
                    >
                        <div class="flex lg:justify-center w-[50px]">
